...
export default defineConfig({
    ...
    shortcuts: {
        ...
        'glass-header': 'fixed top-0 left-0 w-full px-8 py-6 flex justify-between items-center backdrop-blur-md bg-[var(--header-bg)] border-b border-[var(--glass-border)] z-1000 box-border',
