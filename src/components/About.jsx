...
const About = () => {
    ...
    return (
        <section id="about" className="py-12 md:py-24 px-4 md:px-8 max-w-1000px mx-auto">
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <h2 className="text-2xl md:text-3xl mb-6 md:mb-8 flex items-center text-[var(--text-color)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-8 md:gap-12 items-start">
                    <div>
                        <p className="mb-4 text-[var(--text-secondary)] text-base md:text-lg leading-relaxed">
                        ...
                        <p className="mb-4 md:mb-6 text-[var(--text-secondary)] text-base md:text-lg leading-relaxed">
                            Here are a few technologies I've been working with recently:
                        </p>
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-2 p-0 m-0 list-none">
                            {skills.map((skill, i) => (
                                <li key={i} className="relative pl-5 mb-2 font-mono text-xs md:text-sm text-[var(--text-secondary)]">
